 ...
 */
public class EvaluationInputFragment extends Fragment {
     ...
     * @return A new instance of fragment EvaluationInputFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static EvaluationInputFragment newInstance(String param1, String param2) {
        EvaluationInputFragment fragment = new EvaluationInputFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TabletStateContext.getInstance().handleMessge(mainActivity.getRecordState(),mainActivity.getObservableZXDCSignalListenerThread(), null, null, RecSignal.SAVEEVALUATION);
            }
        });
        return view;
    }
